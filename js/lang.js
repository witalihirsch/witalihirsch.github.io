const translations = {
  en: {
    ...
    feedback: "There'll be a feedback form here someday, but now:",
    telegram: 'Telegram:',
    email: 'Email:',
  ...
  ru: {
    ...
    about: 'Я UI/UX Дизайнер и Web-разработчик',
    stages: 'Этапы',
    ...
    feedback: "Здесь будет форма обратной связи, а пока что:",
    telegram: 'Телеграм:',
    email: 'Почта:',
...
const languageSelect = document.querySelector('.switcher');
