...
btnControl.addEventListener('click', function() {
    if (hintControl.style.display == 'block') {
        ...
        window.setTimeout(function() { hintControl.style.opacity = '0'; }, 250);
    } else {
        hintControl.style.display = 'block';
        window.setTimeout(function() { hintControl.style.transform = 'translate(0px, 1.5%)'; }, 20);
        window.setTimeout(function() { hintControl.style.opacity = '1'; }, 250);
    }
});
...
btnLang.addEventListener('click', function() {
    if (hintLang.style.display == 'block') {
        ...
        window.setTimeout(function() { hintLang.style.opacity = '0'; }, 250);
    } else {
        hintLang.style.display = 'block';
        window.setTimeout(function() { hintLang.style.transform = 'translate(0px, 5%)'; }, 20);
        window.setTimeout(function() { hintLang.style.opacity = '1'; }, 250);
    }
});
...
btnCalendar.addEventListener('click', function() {
    if (hintCalendar.style.display == 'block') {
        hintCalendar.style.transform = 'translate(-50%, 0px)';
        window.setTimeout(function() { hintCalendar.style.display = 'none'; }, 20);
        window.setTimeout(function() { hintCalendar.style.opacity = '0'; }, 250);
    } else {
        hintCalendar.style.display = 'block';
        window.setTimeout(function() { hintCalendar.style.transform = 'translate(-50%, 1%)'; }, 20);
        window.setTimeout(function() { hintCalendar.style.opacity = '1'; }, 250);
    }
});